...
// Allowed file types for lab reports
...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    const uploadPath = path.join("public", "upload", "lab-documents");
...
const upload = multer({
  ...
  { name: "ultrasoundFile", maxCount: 1 }
]);

// Middleware wrapper
const labDocumentUpload = (req, res, next) => {
